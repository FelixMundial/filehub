  ...
  <el-container class="welcome-container">
    <el-main class="global-container">
      ...
      >
        ...
        <!--          </el-select>-->
        <!--        </el-form-item>-->
        <el-form-item label="注册账号" prop="loginName">
          <el-input
        ...
        <el-form-item label="注册密码" prop="loginPassword">
          <el-input
        ...
        <el-form-item label="确认密码" prop="loginPasswordCorrect">
          <el-input
                  v-model="loginInfo.loginPasswordCorrect"
                  show-password
                  clearable
                  prefix-icon="el-icon-warning-outline"
          ></el-input>
        ...
        <el-form-item>
          <el-button
                  ...
                  v-bind:disabled="passwordCorrect()"
                  type="primary"
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        loginInfo: { loginType: "", loginName: "", loginPassword: "" , loginPasswordCorrect : ""  },
        responseResult: {},
        registrationRule: {
          loginName: [
    ...
    methods: {
      ...
      passwordCorrect(){
        if(this.loginInfo.loginPassword != this.loginInfo.loginPasswordCorrect || this.loginInfo.loginPassword.length < 6 || this.loginInfo.loginPassword.length>16)
          return true;
        else
          return false;
      },
